...
| Configuration Type       | Sets     | Blocks/Set | Block Size (Bytes) | Write Policy                   | Eviction Policy | Hit Rate (%) | Miss Rate (%) | Total Cycles |
|--------------------------|----------|------------|--------------------|--------------------------------|-----------------|--------------|---------------|--------------|
...
| Set-Associative          | 256      | 4          | 256               | Write-allocate, Write-back      | FIFO            | 99.751       | 0.249         | 10250083     |
|                          | 1024     | 4          | 64                | Write-allocate, Write-through   | LRU             | 99.343       | 0.657         | 25251977     |


Analysis:
- Fully Associative: High hit rates (over 99%) for write-back configurations indicate excellent cache performance, especially for larger block sizes (4096 bytes). However, the miss rates increase significantly when using FIFO and no-write-allocate policies.
